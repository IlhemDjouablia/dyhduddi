...
if (isset($_SESSION['idm']) && isset($_SESSION['namem'])) {
    ...
    if (isset($id)) {
        ...
        $sql = "SELECT * FROM att where intern_name='$id'GROUP BY date ORDER BY date DESC";  
...
<script type="text/javascript">
	$(document).ready(function(){
        ...
        <section id="home-section" class="page-section ">
               ...
               <a href="intern.php" data-section="profile"> <button class="bgt88">back</button> </a>
           
                
           <a href="take.php?id=<?=$id?>" data-section="profile"> <button class="bgt88">take attendance</button> </a>
                  ...
                  <tr class="score-card">
                     ...
                     <td> <br><?=$row['date']?></td>
                        ...
                        <td> <br>
                                ...
                                <a href="att.php?id=<?=$row['intern_name']?>&date=<?=$row['date']?>" data-section="profile"> <button class="bgt88">view</button> </a></td>
