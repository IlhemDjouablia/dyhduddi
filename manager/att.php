...
<script type="text/javascript">
	$(document).ready(function(){
        ...
        <section id="home-section" class="page-section ">
               ...
               <a href="attendence.php?id=<?=$id?>" data-section="profile"> <button class="bgt88">back</button> </a>
    ...
    <h1>
        <?=$date?>
           ...
           <a href="attupdate.php?id=<?=$id?>&date=<?=$date?>" data-section="profile"> <button class="bgt88">update</button> </a>
